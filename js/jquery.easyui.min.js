...
_c4=_c4.replace(/{djy}/,_c0.pageNumber);
_c4=_c4.replace(/{gjy}/,_c1);
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"第{djy}页 / 共{gjy}页  共{total}条",nav:{first:{iconCls:"pagination-first",handler:function(){
